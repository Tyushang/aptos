...
def build_model(trained_model_path=MODEL_PATH,
    ...
    if trained_model_type == 'weights':
        ...
        #     b3layer = list(filter(lambda layer: layer.name == 'efficientnet-b3', model.layers))
        #     load_weights_from_hdf5_group_by_name(f, b3layer)
...
y_true_reg_train_valid = label_counts_2_regression(diagnosis_list, regression_table=REG_TABLE)
